                                        ...
                                        <table class="display nowrap myTable" style="width: 100%">
                                            ...
                                            foreach ($result as $row) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <a href="<?php echo base_url(); ?>index.php/welcome/edit_project?id=<?php echo $row->id;?> " 
                                                            title="edit">
                                                            <i>edit</i></a>
                                                            <a onclick="confirm('Do you want to delete?')" href="<?php echo base_url(); ?>index.php/welcome/delete_project?id=<?php echo $row->id;?> " 
                                                            title="delete">
                                                            <i>delete</i></a>
                                                        </td>
