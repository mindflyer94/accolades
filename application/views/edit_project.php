...
<?php
                ...
                ?>
                            ...
                            <?php echo form_open('welcome/get_project', 'enctype="multipart/form-data"  
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-4 offset-lg-1">
                                            ...
                                            <input class="form-control" type="text" name="project_name" id="project_name" value="<?php  echo $p_name; ?>"/>
                                        </div>
